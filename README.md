...
│       ├── stats/
│       │   ├── batch/         # DailyStatsBatchJob (Spring Batch, 3 Steps), BatchMetricsPusher
│       │   ├── controller/    # StatsController
│       │   ├── domain/        # DailyStat, WeeklyStat, StreakStat, TodoEvent, WeeklyGoal
...
```
statsJob (매일 새벽 1시)
  ├── Step 1: dailyStatsStep   — 어제 이벤트 기반 일별 달성률 집계
  ├── Step 2: weeklyStatsStep  — 주별 달성률 + 목표 달성 여부 집계
  └── Step 3: streakStatsStep  — 월요일에만 실행, 스트릭 업데이트
```
